...
export const metadata: Metadata = {
  ...
  description: "Fagency is a professional freelancers team with 1+ year of experience in Malappuram, Kerala. We provide high-quality web, app, and software development solutions.",
