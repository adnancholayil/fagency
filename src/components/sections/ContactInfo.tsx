import { Mail, Instagram, MessageSquare, Globe } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {[
            ...
            <div key={i} className="p-10 rounded-3xl bg-white/[0.02] border border-white/[0.05] hover:border-[#FFC107]/20 transition-all duration-500 group">
              ...
              <a href={item.link} target="_blank" rel="noopener noreferrer" className="text-xs uppercase tracking-[0.2em] font-medium text-white hover:text-[#FFC107] transition-colors flex items-center gap-2">
